...
def create_strategy_demo():
    ...
    demo_code = '''
# Example usage of PolymarketMarketMaker

from analysis.strategy_implementation import PolymarketMarketMaker, StrategyConfig
...
strategy = PolymarketMarketMaker(config)
...
if __name__ == "__main__":
    ...
    config = StrategyConfig()
    strategy = PolymarketMarketMaker(config)
    print("PolymarketMarketMaker initialized successfully!")
