...
class TestMarketScreener:
    ...
    def test_basic_criteria_filtering(self):
        ...
        good_market.rewards = {"rates": [{"rewards_daily_rate": 50.0}]}
            ...
            "data": [
                {
                    ...
                    "rewards": {
                        "rates": [
                            {"asset_address": "0x1234", "rewards_daily_rate": 100.0}
                        ],
                        "min_size": 50.0,
                        "max_spread": 0.03,
                    },
            ...
            "data": [
                {
                    ...
                    "rewards": {
                        "rates": [
                            {"asset_address": "0x1234", "rewards_daily_rate": 200.0}
                        ],
                        "min_size": 30.0,
                        "max_spread": 0.04,
                    },
                ...
                },
                {
                    ...
                    "rewards": {
                        "rates": [
                            {"asset_address": "0x1234", "rewards_daily_rate": 20.0}
                        ],
                        "min_size": 100.0,
                        "max_spread": 0.02,
                    },
